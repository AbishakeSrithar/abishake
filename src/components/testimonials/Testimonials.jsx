      ...
      <div className="container">
        ...
        <div className={d.featured ? "card featured" : "card"}>
          <div className="top">
            ...
            <img src={d.img.startsWith("https") ? d.img : `${process.env.PUBLIC_URL}/${d.img}`} className="user" alt="" />
            <img src={`${process.env.PUBLIC_URL}/${d.icon}`} className="right" alt="" />
          </div>
